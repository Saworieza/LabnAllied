class BankingsController < ApplicationController
  ...
  # GET /bankings.json
  def index
    @bankings = Banking.all.paginate(page: params[:page], per_page: 15)
  end
  ...
  private
    ...
    def banking_params
      params.require(:banking).permit(:bank_name, :bank_branch, :Account_number, :branch_code, :branch_description, :swift_code, :other_details, :email)
    end
end
