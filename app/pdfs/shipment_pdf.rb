class ShipmentPdf < Prawn::Document
  ...
  def header
    ...
    image "#{Rails.root}/app/assets/images/logo.png", width: 220, height: 50
  end
  ...
  def shipments_rows
    [['Order id', 'Name', 'Price']] +
      @shipments.map do |ship|
      [ship.id, ship.country_of_origin, ship.supply_nature]
    end
  end
end