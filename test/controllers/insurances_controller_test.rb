...
class InsurancesControllerTest < ActionController::TestCase
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post :create, insurance: { insurance_name: @insurance.insurance_name, total_insurance_charges: @insurance.total_insurance_charges }
    end
  ...
  test "should update insurance" do
    patch :update, id: @insurance, insurance: { insurance_name: @insurance.insurance_name, total_insurance_charges: @insurance.total_insurance_charges }
    assert_redirected_to insurance_path(assigns(:insurance))
  end
